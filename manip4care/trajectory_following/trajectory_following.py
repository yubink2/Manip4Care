...
from manip4care.trajectory_following.trajectory_following_handshake import TrajectoryFollower_H_Handshake
...
class TrajectoryFollower(nn.Module):
    ...
    def _init_H_clamping(self, eef_to_cp, elbow_joint_to_cp,
        ...
        self.H_handshake = TrajectoryFollower_H_Handshake(eef_to_cp = eef_to_cp, 
                                                          elbow_joint_to_cp = elbow_joint_to_cp,

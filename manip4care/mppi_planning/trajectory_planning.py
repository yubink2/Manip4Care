...
import manip4care.mppi_planning.mppi_planning as mppi
from manip4care.mppi_planning.cost import PathLengthCost, CollisionCost, ConvergenceCost, ManipulabilityCost

# Import C-SDF
from manip4care.resources.csdf.csdf.pointcloud_sdf import PointCloud_CSDF
...
class TrajectoryPlanner:
    def __init__(
        ...
        robot_urdf_location: str,
        scene_urdf_location: str,
        control_points_location: str,
        ...
        self.mppi_H_handshake = mppi_H_handshake
    ...
    def _mppi_dynamics(
        ...
        if self.clamp_by_human:
            state = self.mppi_H_handshake.clamp_human_joints(state, self._device)
    ...
    def instantiate_mppi_ja_to_ja(
        ...
        # TODO store initial trajectory
        self._init_traj = np.array(init_traj)
        self._init_traj_tensor = torch.from_numpy(self._init_traj).double().to(self._device)
        ...
        self._cost_collision = CollisionCost(
            ...
            distance_threshold = collision_threshold,
        )

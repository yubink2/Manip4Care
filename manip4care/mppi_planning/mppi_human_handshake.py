...
class MPPI_H_Handshake():
    ...
    def clamp_human_joints(self, q_R_list, device):
        for idx, q_R in enumerate(q_R_list):
            ...
            world_to_elbow_joint_actual = self.bc_second.getLinkState(self.humanoid._humanoid, self.elbow)[4:6]
            world_to_cp = self.bc_second.multiplyTransforms(world_to_elbow_joint_actual[0], world_to_elbow_joint_actual[1],

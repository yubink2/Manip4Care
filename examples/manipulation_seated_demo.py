...
if __name__ == '__main__':
    ...
    manip_env.reset_base_pose(manip_env.robot_m.id, base_pose[0], base_pose[1])
    manip_env.reset_base_pose(manip_env.cube_m_id, cube_base_pose[0], cube_base_pose[1])
    wiping_env.reset_base_pose(wiping_env.robot_m.id, base_pose[0], base_pose[1])
    wiping_env.reset_base_pose(wiping_env.cube_m_id, cube_base_pose[0], cube_base_pose[1])
